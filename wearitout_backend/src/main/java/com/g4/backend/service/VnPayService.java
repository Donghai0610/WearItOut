...
import com.g4.backend.config.VnPayConfiguration;
...
public class VnPayService {
    ...
    public VnPayResponseDTO createPayment(Long total, int orderId) throws UnsupportedEncodingException {
        ...
        vnPayResponseDTO.setStatus("OK");
        vnPayResponseDTO.setMessage("Success");
        vnPayResponseDTO.setUrl(paymentUrl);
